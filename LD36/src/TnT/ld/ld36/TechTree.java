...
public class TechTree extends Overlay{
	...
	static Tech relays = new Tech("Relays", "Runner better at delivering things.", 2.1, Transport.RUNNER);
	static Tech carrot = new Tech("Carrot on a Stick", "Motivated horses to move faster", 1.27589, Transport.HORSE, Transport.CARRIAGE, Transport.CARAVAN);
	static Tech spurs = new Tech("Spurs", "Better control of horses", 1.5, Transport.HORSE);
	static Tech ironHorseShoes = new Tech("Iron Horse Shoes", "Increase horse speed by 35%", 1.35, Transport.HORSE, Transport.CARRIAGE, Transport.CARAVAN);
	static Tech smithing = new Tech("Smithing", "Make cool stuff", 1.1, City.class);
	static Tech smootherRoads = new Tech("Smoother Roads", "Runners and horses dont trip.", 1.5, Transport.RUNNER, Transport.HORSE, Transport.CARAVAN, Transport.CARRIAGE);
