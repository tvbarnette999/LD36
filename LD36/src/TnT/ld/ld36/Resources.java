...
public class Resources {
	...
	public static InputStream getInputStream(String name) throws FileNotFoundException {
		InputStream in;
		/*
		 * try root save directory first- if we need to change a file on the fly
		 * it loads that one first (also any mod like add team- rewrite new
		 * event data file there and its saved)
		 */
		try {
