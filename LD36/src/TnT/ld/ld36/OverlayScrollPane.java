...
public class OverlayScrollPane extends Overlay {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4762736182474190300L;
	...
	public void mousePressed(MouseEvent e) {
		if (hbar.contains(e.getPoint())) {
			...
			inner.mousePressed(new MouseEvent(e.getComponent(), e.getID(), e.getWhen(), e.getModifiers(),
					e.getX() + (int) hscroll, e.getY(), e.getXOnScreen(), e.getYOnScreen(), e.getClickCount(),
	...
	public void mouseReleased(MouseEvent e) {
		if (hactive) {
			...
			inner.mouseReleased(new MouseEvent(e.getComponent(), e.getID(), e.getWhen(), e.getModifiers(),
					e.getX() + (int) hscroll, e.getY(), e.getXOnScreen(), e.getYOnScreen(), e.getClickCount(),
					e.isPopupTrigger(), e.getButton()));
	...
	public void mouseClicked(MouseEvent e) {
		if (inner != null)
			inner.mouseClicked(new MouseEvent(e.getComponent(), e.getID(), e.getWhen(), e.getModifiers(),
					e.getX() + (int) hscroll, e.getY(), e.getXOnScreen(), e.getYOnScreen(), e.getClickCount(),
					e.isPopupTrigger(), e.getButton()));
	}
	...
	public void mouseMoved(MouseEvent e) {
		inner.mouseMoved(new MouseEvent(e.getComponent(), e.getID(), e.getWhen(), e.getModifiers(),
				e.getX() + (int) hscroll, e.getY(), e.getXOnScreen(), e.getYOnScreen(), e.getClickCount(),
				e.isPopupTrigger(), e.getButton()));
